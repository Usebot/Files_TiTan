...
if database:get(bot_id.."TiTan:skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then   
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, 1, "*💥¦* تم الغاء امر الزخرفه ✔", 1, "md")
database:del(bot_id.."TiTanskrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
if text then
if utf8.len(text) > 20 then
send(msg.chat_id_, msg.id_, 1,'*📮¦ لا يمكن زخرفة اكثر من 20 حرف *', 1, 'md') 
database:del(bot_id.."TiTan:skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_)     
return false
end
...
if database:get(bot_id..'TiTan:lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تفعيل الزخرفه *\n✓' 
send( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
database:del(bot_id..'TiTan:lock:skrfa'..msg.chat_id_) 
else
...
if not database:get(bot_id..'TiTan:lock:skrfa'..msg.chat_id_)  then
taha = '*📮¦ تم تعطيل الزخرفه *\n✓' 
send( msg.chat_id_, msg.id_, 1, taha, 1, "md") 
database:set(bot_id..'TiTan:lock:skrfa'..msg.chat_id_,true) 
else
...
if not database:get(bot_id.."TiTan:lock:skrfa"..msg.chat_id_) then   
database:setex(bot_id.."TiTan:skrafa:name" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 10000, true)   
