...
local TiTanChengPhoto = redis:get(bot_id.."TiTan:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TiTanChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
redis:del(bot_id.."TiTan:Cheng:Photo"..data.id_) 
end
end
...
redis:set(bot_id.."TiTan:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
